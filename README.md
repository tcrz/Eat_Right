...
---
<p>:fork_and_knife: Click <a href="http://web-02.yoursamie.tech/eat_right">here </a> to enjoy the deployed app.<p>
---
...
<p>What you'll do is add your breakfast, lunch, and supper meals then the counter will display how much you ate.
You will then get to compare it with the amount of daily calories intake of calorie preditor. User can remove food items by clicking on the red dash on the right of each row.</p>
---
